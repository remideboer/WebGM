...
// MagicGenerator - Magical effects generation functionality
  ...
  generate() {
    ...
    switch (
      ...
      case magCat == "sensorium":
        ...
        let list;
        // Use object property access instead of eval
        if (effect == "see") {
          list = seeList;
        } else if (effect == "hear") {
          list = hearList;
        } else if (effect == "smell") {
          list = smellList;
        } else if (effect == "taste") {
          list = tasteList;
        } else if (effect == "feel") {
          list = feelList;
